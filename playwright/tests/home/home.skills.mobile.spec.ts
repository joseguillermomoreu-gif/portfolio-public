...
const SKILL_CORNERS = [
  { position: 1, label: 'superior izquierda', snapshot: 'home-skills-grid-mobile-expanded-top-left.png' },
  { position: 2, label: 'superior derecha',   snapshot: 'home-skills-grid-mobile-expanded-top-right.png' },
  { position: 5, label: 'inferior izquierda', snapshot: 'home-skills-grid-mobile-expanded-bottom-left.png' },
  { position: 6, label: 'inferior derecha',   snapshot: 'home-skills-grid-mobile-expanded-bottom-right.png' },
];
