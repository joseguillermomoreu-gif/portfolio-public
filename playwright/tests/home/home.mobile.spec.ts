...
test('home visual hero', { tag: ['@test', '@home', '@styles'] }, async ({ page }) => {
...
test('home visual quick intro: stats', { tag: ['@test', '@home', '@styles'] }, async ({ page }) => {
  await test.step('When: el usuario navega a la página principal', async () => {
    await homePage.navigateHome(page);
  });
...
test('home visual contexto', { tag: ['@test', '@home', '@styles'] }, async ({ page }) => {
  await test.step('When: el usuario navega a la página principal', async () => {
    await homePage.navigateHome(page);
  });
...
test('home visual foco', { tag: ['@test', '@home', '@styles'] }, async ({ page }) => {
  await test.step('When: el usuario navega a la página principal', async () => {
    await homePage.navigateHome(page);
  });
